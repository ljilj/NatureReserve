...
function NatureReserve_register_King_Khalid_reserve() {
    $singular = 'King Khalid Reserve'; // Book
	$plural = 'King Khalid Reserves';  // Books
...
add_action( 'init', 'NatureReserve_register_King_Khalid_reserve' );