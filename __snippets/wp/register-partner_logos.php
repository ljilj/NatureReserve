...
add_action( 'admin_bar_menu', function( \WP_Admin_Bar $bar )
{
   $bar->add_menu( array(
         ...
         'meta'   => array(
               'target'   => '_blank',
               'title'    => __( 'Up&Up Support', 'NatureReserve' ),
               'html'     => '',
               'class'    => 'wpse--item',
               'rel'      => 'up3up',
...
add_action( 'admin_bar_menu', function( \WP_Admin_Bar $bar )
{
   $bar->add_menu( array(
         ...
         'parent' => null,
         'group'  => null,
         'title'  => __( '<img style="width: 130px;" src="https://www.webkrunch.be/media/images/webkrunch-logo-wp.png" />', 'some-textdomain' ),
         'href'   => 'https://www.webkrunch.be',
         'meta'   => array(
               'target'   => '_blank',
               'title'    => __( 'Webkrunch Support', 'NatureReserve' ),
               'html'     => '',
               'class'    => 'wpse--item',
               'rel'      => 'webkrunch',
               'tabindex' => PHP_INT_MAX,
...
add_action( 'admin_bar_menu', function( \WP_Admin_Bar $bar )
{
   $bar->add_menu( array(
         ...
         'meta'   => array(
               'target'   => '_blank',
               'title'    => __( 'LibraFire Support', 'NatureReserve' ),
               'html'     => '',
               'class'    => 'wpse--item',
               'rel'      => 'librafire',
               'tabindex' => PHP_INT_MAX,
